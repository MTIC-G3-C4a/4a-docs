"""
Django settings for urgenciasProject project.
...
SECRET_KEY = 'django-insecure-idkl#l1li@4iogrfml_(n$vs@n=_t@45#ro_xp_1_o&wi@h-4t'
...
WSGI_APPLICATION = 'urgenciasProject.wsgi.application'
